...
PRIVATE_CONFIG=constellation.config nohup geth --datadir Blockchain $GLOBAL_ARGS --rpcport 20010 --port 20000 --voteaccount $1 --votepassword "" --blockmakeraccount $2 --blockmakerpassword "" --singleblockmaker --minblocktime 2 --maxblocktime 5 --preload "pauseBlockMaking.js" &> gethNode.log &
sleep 5
