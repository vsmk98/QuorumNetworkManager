...
PRIVATE_CONFIG=constellation.config nohup geth --datadir Blockchain $GLOBAL_ARGS --rpcport 20010 --rpccorsdomain "*" --port 20000 --voteaccount $1 --votepassword "" --minblocktime $2 --maxblocktime $2 &> gethNode.log &
sleep 5
