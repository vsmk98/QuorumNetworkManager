...
PRIVATE_CONFIG=constellation.config nohup geth --datadir Blockchain $GLOBAL_ARGS --rpcport $4 --rpccorsdomain "*" --port $5 --voteaccount $1 --votepassword "" --minblocktime $2 --maxblocktime $3 &> gethNode.log &
sleep 5
